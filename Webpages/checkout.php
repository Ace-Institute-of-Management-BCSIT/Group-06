...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  :focus-visible{ outline:2.5px solid var(--blue-accent); outline-offset:2px; }

  /* ---------- SIDEBAR (matches dashboard / inventory / products exactly) ---------- */
  .pos-sidebar{
    position:fixed;
    left:0; top:0;
    width:264px;
  ...
  .pos-brand:hover{ opacity:.88; }
  .pos-brand .mark{
    width:38px; height:38px;
    border-radius:11px;
    background:linear-gradient(135deg,var(--blue-accent),#9a5cf0);
    display:grid;
    place-items:center;
    box-shadow:0 4px 14px rgba(91,110,245,.45);
    flex-shrink:0;
  }
  .pos-brand .mark svg{ width:20px; height:20px; }
  .pos-brand .text{ font-size:18.5px; font-weight:800; color:#fff; letter-spacing:-.02em; }
  .pos-brand .text span{ color:var(--accent-light); font-weight:800; }
  .pos-brand .sub{ font-size:10.5px; color:#7986bd; letter-spacing:.05em; margin-top:1px; }

  .pos-nav-scroll{ flex:1; overflow-y:auto; }
  ...
  .pos-menu{ list-style:none; display:flex; flex-direction:column; gap:3px; }
  ...
  .pos-menu li .left{ display:flex; align-items:center; gap:11px; text-decoration:none; color:inherit; flex:1; }
  .pos-menu li svg{ width:18px; height:18px; opacity:.85; flex-shrink:0; }
  .pos-menu li:hover{ background:rgba(255,255,255,.07); color:#fff; }
  .pos-menu li.active{
    background:linear-gradient(90deg, var(--blue-accent) 0%, #7b6af2 100%);
    color:#fff;
    box-shadow:0 6px 16px rgba(91,110,245,.35);
  }
  .pos-menu li.active svg{ opacity:1; }
  ...
  .pos-badge.amber{ background:var(--amber); }
  .pos-badge.red{ background:var(--red); }
  ...
  .pos-profile:hover{ background:rgba(255,255,255,.06); }
  .pos-avatar{
    width:38px; height:38px;
    border-radius:50%;
  ...
  .pos-profile b{ font-size:13px; color:#fff; display:block; }
  .pos-profile p{ font-size:11px; color:#8b96c9; margin-top:1px; }
  ...
  .pos-sidebar-toggle{
    ...
    align-items:center;
    justify-content:center;
    box-shadow:0 4px 16px rgba(15,18,38,.2);
  }
  .pos-sidebar-toggle svg{ width:20px; height:20px; color:#fff; }
  ...
  @media (max-width:880px){
    .pos-sidebar{ transform:translateX(-100%); transition:transform .3s var(--ease); }
    .pos-sidebar.open{ transform:translateX(0); }
    .pos-sidebar-toggle{ display:grid; }
...
<button class="pos-sidebar-toggle" id="posSidebarToggle" aria-label="Toggle menu">
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
</button>
<div class="pos-sidebar-backdrop" id="posSidebarBackdrop"></div>

<aside class="pos-sidebar" id="posSidebar" aria-label="StockSmart navigation">
  <a class="pos-brand" href="homepage.html" aria-label="StockSmart home">
    <div class="mark">
    ...
    <div>
      <div class="text">Stock<span>Smart</span></div>
      <div class="sub">INVENTORY OS</div>
    </div>
  </a>

  <div class="pos-nav-scroll">
    <p class="pos-menu-title">MAIN</p>
    <ul class="pos-menu">
      <li><a class="left" href="dashboard.html">
        ...
        Dashboard</a></li>
      <li><a class="left" href="products.html">
        ...
        Products</a></li>
      <li><a class="left" href="inventory.html">
        ...
        Inventory</a></li>
      <li class="active"><a class="left" href="checkout.php">
    ...
    <p class="pos-menu-title">ALERTS</p>
    <ul class="pos-menu">
      <li><span class="left">
        ...
        Restocking Alerts</span><span class="pos-badge amber">8</span></li>
      <li><span class="left">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
        Expiry Alerts</span><span class="pos-badge red">16</span></li>
    </ul>

    <p class="pos-menu-title">ADMIN</p>
    <ul class="pos-menu">
      <li><span class="left">
...
(function(){
  ...
  const posToggle = document.getElementById('posSidebarToggle');
  const posBackdrop = document.getElementById('posSidebarBackdrop');
  function openSidebar(){ posSidebar.classList.add('open'); posBackdrop.classList.add('show'); }
  function closeSidebar(){ posSidebar.classList.remove('open'); posBackdrop.classList.remove('show'); }
  if (posToggle && posSidebar && posBackdrop) {
    posToggle.addEventListener('click', () => posSidebar.classList.contains('open') ? closeSidebar() : openSidebar());
    posBackdrop.addEventListener('click', closeSidebar);
  }
})();
</script>
